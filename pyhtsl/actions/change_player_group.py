...
class ChangePlayerGroupExpression(Expression):
    ...
    def cloned(self) -> Self:
        return self.__class__(group=self.group, demotion_protection=self.demotion_protection)

    def equals(self, other: object) -> bool:
        if not isinstance(other, ChangePlayerGroupExpression):
            return False
        return self.group.name == other.group.name and self.demotion_protection == other.demotion_protection
...
def change_player_group(group: Group | str, demotion_protection: bool = True) -> None:
    ...
    ChangePlayerGroupExpression(group=group, demotion_protection=demotion_protection).write()
