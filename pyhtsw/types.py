...
from pyhtsw.nbt import NBTCompound
...
ALL_ITEM_KEY_STRINGS = NON_SPECIAL_ITEM_KEYS | DAMAGEABLE_ITEM_KEYS | LEATHER_ARMOR_KEYS | COOKIE_ITEM_KEY | PLAYER_SKULL_ITEM_KEY


ALL_ITEM_KEYS = ALL_ITEM_KEY_STRINGS | tuple[LEATHER_ARMOR_KEYS, ColorType] | tuple[PLAYER_SKULL_ITEM_KEY, NBTCompound | None]
